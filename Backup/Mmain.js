...
mixCtrller.$inject = ['MixCenter'];

function mixCtrller (MixCenter){// Open the main controller function
  var TheMix = this;
  
  TheMix.greeting = "Make Your Spot How You Want";
  TheMix.instructions1="Use a total of five options to make your 'My Spot' Playlist";
  TheMix.instructions2="Example 1: Artist1, Song1, Genre1, Genre2, Genre3";
  TheMix.instructions3="Example 2: Artist1, Artist2, Song1, Song2,  Genre1";
  TheMix.instructions4="Example 3: Artist1, Artist2, Song1, Genre1, Genre2";
...
if(genre5){ // Genre 5 case test
  ...
  async.parallel(bld_seeds,function(err,SeedArray){
     ...
     TheMix.mixTitle="Your My Spot Playlist:"; 
 ...
 function getTrack5 (song5) { //Open fetch to Spotify to get Track 5 ID
  ...
  function getRecoms (numSongs,artSeeds,gnrSeeds,sngSeeds) { //Open fetch to Spotify to get Recommendation Seeds
    return $http({
      ...
      headers : { Authorization : "Bearer BQD5Qh8UosM7kWxDexpUVQ6os1Krlz05V7wzi6MOc5-0QP9KYwxFtJmU3nw8JzC4UbAi_UeqqC1F6HP95oY8dLpufnvDaQHlnxRDp526SBzvHaXF6BJQMz94eI-dc2G2vm6LqE09jKc"
      }, 
      params  : {
      limit        : numSongs,  
